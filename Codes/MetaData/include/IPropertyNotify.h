...
public:
	virtual void BeginSet(void *pObj, TDUIntPtr PropertyTag, void *value) = 0;
	virtual void EndSet(void *pObj, TDUIntPtr PropertyTag, void *value) = 0;
	virtual void BeginGet(void *pObj, TDUIntPtr PropertyTag) = 0;
	virtual void EndGet(void *pObj, TDUIntPtr PropertyTag, void *value) = 0;
