...
MD_INTERFACE_DECLARE_DETAIL_KERNEL(IContainer)
	...
	MD_INTERFACE_MEMBER_FUNC_DEF(NewItem, 0)
		MD_INTERFACE_MEMBER_FUNC_PARAM_DEF(type_index, size_t, MD_NO_ASTERISK)
		MD_INTERFACE_MEMBER_FUNC_RETURN_DEF(void*, MD_NO_ASTERISK)
	MD_INTERFACE_MEMBER_FUNC_DEF(AddItem, 0)
		MD_INTERFACE_MEMBER_FUNC_PARAM_DEF(type_index, size_t, MD_NO_ASTERISK)
		MD_INTERFACE_MEMBER_FUNC_PARAM_DEF(pItem, void*, MD_NO_ASTERISK)
		MD_INTERFACE_MEMBER_FUNC_RETURN_DEF(bool, MD_NO_ASTERISK)
	...
	MD_INTERFACE_MEMBER_FUNC_DEF(Count, 0)
		MD_INTERFACE_MEMBER_FUNC_PARAM_DEF(type_index, size_t, MD_NO_ASTERISK)
		MD_INTERFACE_MEMBER_FUNC_RETURN_DEF(size_t, MD_NO_ASTERISK)
	MD_INTERFACE_MEMBER_FUNC_DEF(GetItem, 0)
		MD_INTERFACE_MEMBER_FUNC_PARAM_DEF(type_index, size_t, MD_NO_ASTERISK)
		MD_INTERFACE_MEMBER_FUNC_PARAM_DEF(index, size_t, MD_NO_ASTERISK)
		MD_INTERFACE_MEMBER_FUNC_RETURN_DEF(void*, MD_NO_ASTERISK)
